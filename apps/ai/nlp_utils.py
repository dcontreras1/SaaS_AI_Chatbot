...
async def extract_contact_info(message: str) -> dict:
    ...
    # dateparser.parse es síncrono si hubiera mucho procesamiento aquí,
    # y fuese necesario mantenerlo asíncrono, debería envolverlo en un executor
